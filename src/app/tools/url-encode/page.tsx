  ...
  return (
    ...
    >
      <textarea
        ...
        className="w-full h-28 p-3 border border-stone-200 rounded-lg resize-y focus:outline-none focus:ring-2 focus:ring-[#c2410c]/20 focus:border-transparent font-mono text-sm"
      />
      ...
      {output && (
        <div className="mt-4">
          ...
          <textarea
            readOnly
            value={output}
            className="w-full h-28 p-3 border border-stone-200 rounded-lg resize-y font-mono text-sm bg-stone-50"
          />
        </div>
      )}
    </ToolLayout>
